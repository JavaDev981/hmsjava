...
public class hospitalInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Hospital administration is the primary emphasis of a hospital management system (HMS),\n a component of health informatics. By making a patient's health information\n and visit history available when and when it is required, these systems\n improve the ability of healthcare practitioners to coordinate care.");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 284, 730, 160));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(583, 462, -1, -1));
